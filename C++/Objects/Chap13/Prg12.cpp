/**************************************************************
 * The application file to test to Fraction class             *
 **************************************************************/
...
int main ()
{
  //Creation of two objects and testing plus/minus operator 
  Fraction fract1 (2, 3);
  Fraction fract2 (1, 2);
  ...
  // Creation of four objects and testing the ++ and --
  Fraction fract3 (3, 4);
  Fraction fract4 (4, 5);
  Fraction fract5 (5, 6);
  Fraction fract6 (6, 7);
  ...
  // Creation of two new objects and testing friend operations
  ...
  Fraction fract16 (23.45);//Changing a double  to a fraction
